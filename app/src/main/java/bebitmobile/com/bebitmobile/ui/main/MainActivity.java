...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Action Belum diisi", Snackbar.LENGTH_LONG)
    ...
    public static void startActivity(BaseActivity sourceActivity) {
        Intent i = new Intent(sourceActivity, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_edit_profil) {
            EditProfilActivity.startActivity((BaseActivity) MainActivity.this);
            return true;
        }
        if (id == R.id.action_reset_pass) {
            ResetPassActivity.startActivity((BaseActivity) MainActivity.this);
            return true;
        }
    ...
    @OnClick(R.id.cv_test_iq)
    void showStartTestDialog()
    {
        StartTestDialog std = new StartTestDialog(this);
    }

    @OnClick(R.id.cv_test_java)
    void showStartTestDialog2()
    {
        StartTestDialog std = new StartTestDialog(this);
    }

    @OnClick(R.id.cv_test_personal)
